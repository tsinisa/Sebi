...
(function ($) {
    $.fn.quicksand = function (collection, customOptions) {  
		var makeitFadein = function() { $(this).children('div.portfolio-hover').fadeIn(100, 'easeInOutCubic'); }
		var makeitFadeout = function() { $(this).children('div.portfolio-hover').fadeOut(100, 'easeInOutCubic' );}
