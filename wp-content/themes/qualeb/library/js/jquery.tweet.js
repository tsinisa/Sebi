...
(function($) {
  $.fn.tweet = function(o){
    var s = $.extend({
      ...
      count: null,                                 // [integer]  how many tweets to display?
    ...
    function extract_template_data(item){
	  ...
	  o.avatar = o.avatar_size ?
        t('<a class="tweet_avatar" href="{user_url}"><span class="twitter-icon"></span></a>', o) : '';
      o.time = t('<br /><span class="tweet_time"><a href="{tweet_url}" title="view tweet on twitter">{tweet_relative_time}</a></span><br /><br />', o);
