...
?>
    <div id="widgets" class="sidebar-home">
        ...
        <?php pilotfish_widgets(); // before widgets hook ?> 
            ...
            <?php if (!dynamic_sidebar('sidebar-home-1')) : ?>
                ...
                <div class="textwidget"><?php _e('Test 22 Replace the text here in the sidebar-home.php, or add widgets to Featured One area.','pilotfish'); ?></div>
                </div>
                </section>
	...
	<?php endif; //end of sidebar-home-1 ?>
	    ...
	    <?php if (!dynamic_sidebar('sidebar-home-2')) : ?>
                ...
                <div class="textwidget"><?php _e('Test 3 Replace the text here in the sidebar-home.php, or add widgets to Featured Two area.','pilotfish'); ?></div>
                </div>
                </section>
	...
	<?php endif; //end of sidebar-home-2 ?>
        ...
        <?php pilotfish_widgets(); // before widgets hook ?>
            <?php if (!dynamic_sidebar('sidebar-home-3')) : ?>
                ...
                <div class="textwidget"><?php _e('Test 4 Replace the text here in the sidebar-home.php, or add widgets to Featured Three area.','pilotfish'); ?></div>
                </div>
                </section>
